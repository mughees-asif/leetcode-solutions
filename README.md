...
|  [Reverse Bits](https://leetcode.com/explore/interview/card/top-interview-questions-easy/99/others/648/) | simple [bitwise operator](https://www.tutorialspoint.com/Java-Bitwise-Operators) usage  | [Reversed Bit](https://github.com/mughees-asif/leetcode-solutions/blob/master/Interviews/Math/ReverseBits/src/com/mughees/Main.java) | `O(n)` |
