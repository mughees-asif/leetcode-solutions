...
|  [Container With Most Water](https://leetcode.com/explore/interview/card/google/59/array-and-strings/3048/) | use the two-pointer method | [max area of water the container can contain](https://github.com/mughees-asif/leetcode-solutions/blob/master/Interviews/Arrays/ContainerWithMostWater/src/com/mughees/Main.java) | `O(n)` |
|  [Trapping Rain Water](https://leetcode.com/explore/interview/card/google/59/array-and-strings/3048/) |  | [max area of water the container can contain](https://github.com/mughees-asif/leetcode-solutions/blob/master/Interviews/Arrays/TrappingRainWater/src/com/mughees/Main.java) | `O(n)` |
...
|  [Find And Replace in String](https://leetcode.com/explore/interview/card/google/59/array-and-strings/3057/) | an important detail in the question is that there is no overlapping region | [](https://github.com/mughees-asif/leetcode-solutions/blob/master/Interviews/Strings/FindAndReplace/src/com/mughees/Main.java) | `O(n * r)`, n = length of string, r = replacement operations |
