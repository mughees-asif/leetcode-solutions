...
|  [Permutations](https://leetcode.com/problems/permutations/) | recursive | [all possible permutations](https://github.com/mughees-asif/leetcode-solutions/blob/master/Interviews/Arrays/TrappingRainWater/src/com/mughees/Main.java) | `O(n)` |
