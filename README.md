...
|  [Find And Replace in String](https://leetcode.com/explore/interview/card/google/59/array-and-strings/3057/) |  | [](https://github.com/mughees-asif/leetcode-solutions/blob/master/Interviews/Strings/FindAndReplace/src/com/mughees/Main.java) | `O(n * r)`, n = length of string, r = replacement operations |
