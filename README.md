...
|  [Container With Most Water](https://leetcode.com/explore/interview/card/google/59/array-and-strings/3048/) |  | [max area of water the container can contain](https://github.com/mughees-asif/leetcode-solutions/blob/master/Interviews/Arrays/ContainerWithMostWater/src/com/mughees/Main.java) | 1. `O(n log n)` / 2. `O(n)` |
