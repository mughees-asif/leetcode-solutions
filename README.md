...
|  [Decode String](https://leetcode.com/explore/interview/card/google/59/array-and-strings/3060/
) | account for the 4 types of characters that are encountered using two Stacks | [decoded string](https://github.com/mughees-asif/leetcode-solutions/blob/master/Interviews/Strings/DecodeString/src/com/mughees/Main.java) | `O(n * m)` n = length of input string, m = max. value of digit for decoding |
