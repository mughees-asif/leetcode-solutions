...
|  [Multiply Strings](https://leetcode.com/explore/interview/card/google/59/array-and-strings/3051/) |  | [product of the two input strings](https://github.com/mughees-asif/leetcode-solutions/blob/master/Interviews/Strings/MultiplyStrings/src/com/mughees/Main.java) | `O(n)` |
