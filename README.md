...
|  [Longest Common Prefix](https://leetcode.com/explore/interview/card/top-interview-questions-easy/127/strings/887/) | use `StringBuilder` object to append to previous `Integer` as per the given input `int` | [integer as string at specified place](https://github.com/mughees-asif/leetcode-solutions/blob/master/Interviews/Strings/CountAndSay/src/com/mughees/Main.java) | `O(n)` |
