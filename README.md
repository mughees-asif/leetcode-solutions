...
|  [Decode String](https://leetcode.com/explore/interview/card/google/61/trees-and-graphs/3073/) |  | [decoded string](https://github.com/mughees-asif/leetcode-solutions/blob/master/Interviews/Strings/DecodeString/src/com/mughees/Main.java) | `O(N*M)` N = length of input string, M = max. value of digit for decoding |
